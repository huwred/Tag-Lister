...
namespace Our.community.Tags.Popular.Composers
{
    public class OurcommunityTagsPopularApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Ourcommunity Tags Popular Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<OurcommunityTagsPopularOperationSecurityFilter>();
            });
        }

        public class OurcommunityTagsPopularOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Our.community.Tags.Popular.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
